(function (global, factory) {
    ...
    (global = global || self, factory(global['ngafr-authentication'] = {}, global.ng.core, global.ng.fire.auth, global.rxjs.operators, global.rxjs, global.ng.platformBrowser, global.ng.forms, global.firebaseuiAngular, global.ng.fire, global.firebase, global.firebaseui));
}(this, (function (exports, core, auth, operators, rxjs, platformBrowser, forms, firebaseuiAngular, fire, firebase, firebaseui) { 'use strict';
    ...
    var NgafrAuthenticationService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgafrAuthenticationService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NgafrAuthenticationService_Factory() { return new NgafrAuthenticationService(core.ɵɵinject(auth.AngularFireAuth)); }, token: NgafrAuthenticationService, providedIn: "root" });
    ...
    var NgafrAuthenticationComponent = /** @class */ (function () {
        ...
        NgafrAuthenticationComponent.propDecorators = {
            ngafrAuthElement: [{ type: core.ViewChild, args: ['ngafrAuthElement', { static: true },] }]
        };
    ...
    var NgafrAuthDirective = /** @class */ (function () {
        function NgafrAuthDirective(componentFactoryResolver, viewContainer, cdr, auth, el) {
            ...
            this.userLoggedInEvent = new core.EventEmitter();
            this.userEvent = new core.EventEmitter();
        ...
        NgafrAuthDirective.propDecorators = {
            ngafrAuth: [{ type: core.Input, args: ['ngafrAuth',] }],
            userLogOut: [{ type: core.Input, args: ['userLogOut',] }],
            hideDefaultLogOutButton: [{ type: core.Input, args: ['hideDefaultLogOutButton',] }],
            userLoggedInEvent: [{ type: core.Output, args: ['userLoggedInEvent',] }],
            userEvent: [{ type: core.Output, args: ['userEvent',] }]
        };
     ...
     */
    /** @type {?} */
    var FirebaseConfigData = new core.InjectionToken('FIREBASECONF');
