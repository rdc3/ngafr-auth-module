import { Injectable, ɵɵdefineInjectable, ɵɵinject, Component, ViewEncapsulation, ChangeDetectorRef, ViewChild, EventEmitter, Directive, ComponentFactoryResolver, ViewContainerRef, Input, Output, InjectionToken, NgModule } from '@angular/core';
...
/** @nocollapse */ NgafrAuthenticationService.ɵprov = ɵɵdefineInjectable({ factory: function NgafrAuthenticationService_Factory() { return new NgafrAuthenticationService(ɵɵinject(AngularFireAuth)); }, token: NgafrAuthenticationService, providedIn: "root" });
if (false) {
    /**
     * @type {?}
     * @private
...
class FirebaseConfigService {
    ...
    static getFirebaseUiAuthConfig(authProviders) {
        ...
        if (authProviders.anonymousAuthProvider) {
            FirebaseConfigService.firebaseUiAuthConfig.signInOptions.push(auth.AnonymousAuthProvider.PROVIDER_ID);
        }
 ...
 */
/** @type {?} */
const FirebaseConfigData = new InjectionToken('FIREBASECONF');
